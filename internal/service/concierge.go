...
- "books": one object per book, in the same order:
  ...
  - "why": one sentence, under 110 characters, tying the book to something concrete — their request, a book they rated highly, a pattern you were told about. The reader should recognise themselves in it. Never start with "This book".
